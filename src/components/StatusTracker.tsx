  ...
  const handleTrackCode = (codeToTrack: string) => {
    ...
    if (!app && code === DEFAULT_MOCK_CODE) {
      app = {
         ...
         schemeId: 'pm-kisan',
         schemeName: currentLanguage === 'en' ? 'PM Kisan Samman Nidhi' : 'पीएम किसान सम्मान निधि',
         category: currentLanguage === 'en' ? 'Agriculture' : 'कृषि कल्याण',
         applicantName: currentLanguage === 'en' ? 'Ramesh Suder' : 'रमेश सुदर',
         applicantAge: 42,
         applicantIncome: 120000,
         applicantState: 'Maharashtra',
         applicantOccupation: 'Farmer',
         applicantPhone: '9845******',
         submissionDate: currentLanguage === 'en' ? '15 April 2026' : '15 अप्रैल 2026',
         status: currentLanguage === 'en' ? 'Approved' : 'स्वीकृत',
         timeline: [
           {
             status: currentLanguage === 'en' ? 'Application Submitted' : 'आवेदन जमा किया गया',
             date: currentLanguage === 'en' ? '15 April 2026 — 10:32 AM' : '15 अप्रैल 2026 — सुबह 10:32 बजे',
           ...
           {
             status: currentLanguage === 'en' ? 'Document Verification' : 'दस्तावेज़ सत्यापन',
             date: currentLanguage === 'en' ? '18 April 2026 — 2:15 PM' : '18 अप्रैल 2026 — दोपहर 2:15 बजे',
             description: currentLanguage === 'en'
           ...
           {
             status: currentLanguage === 'en' ? 'Approval Granted' : 'मंजूरी दी गई',
             date: currentLanguage === 'en' ? '22 April 2026 — 9:00 AM' : '22 अप्रैल 2026 — सुबह 9:00 बजे',
             description: currentLanguage === 'en'
           ...
           {
             status: currentLanguage === 'en' ? 'Payment Processing' : 'भुगतान प्रक्रियाधीन',
             date: currentLanguage === 'en' ? 'Expected by 28 May 2026' : '28 मई 2026 तक अपेक्षित',
             description: currentLanguage === 'en'
